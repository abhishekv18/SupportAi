...
(function () {
  ...
  style.textContent = `
    ...
    ._pulse-ring {
      ...
      inset: -4px;
      border-radius: 50%;
      border: 2px solid rgba(184,204,240,0.4);
      animation: _pulse 2.5s ease-out infinite;
    }
    @keyframes _pulse {
      0% { transform: scale(1); opacity: 0.7; }
  ...
  box.innerHTML = `
    ...
    ">
      ...
      <div style="
        position:absolute;inset:0;
        background-image: radial-gradient(circle, rgba(184,204,240,0.08) 1px, transparent 1px);
        background-size: 20px 20px;
        pointer-events:none;
      "></div>
      ...
      <div style="
        width: 40px; height: 40px;
        border-radius: 12px;
        background: rgba(184,204,240,0.15);
        border: 1.5px solid rgba(184,204,240,0.25);
        display: flex; align-items: center; justify-content: center;
        flex-shrink: 0;
        position: relative;
        z-index:1;
      ">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
          <path d="M12 2C8.13 2 5 5.13 5 9c0 2.38 1.19 4.47 3 5.74V17c0 .55.45 1 1 1h6c.55 0 1-.45 1-1v-2.26C17.81 13.47 19 11.38 19 9c0-3.87-3.13-7-7-7z" fill="rgba(184,204,240,0.9)"/>
          <path d="M9 21h6v1H9z" fill="rgba(184,204,240,0.5)"/>
        </svg>
      </div>
      ...
      <div style="flex:1; position:relative; z-index:1;">
        ...
        <div style="display:flex; align-items:center; gap:5px; margin-top:3px;">
          <span style="width:7px;height:7px;border-radius:50%;background:#4ade80;box-shadow:0 0 6px rgba(74,222,128,0.7);flex-shrink:0;"></span>
          <span style="font-size:11px; color:rgba(184,204,240,0.75); font-weight:400;">Online · Typically replies instantly</span>
        </div>
      </div>
  ...
  function injectWelcome() {
    ...
    wrap.innerHTML = `
      ...
      ">
        <div style="width:22px;height:22px;border-radius:7px;background:linear-gradient(135deg,#0f172a,#1e3a5f);display:flex;align-items:center;justify-content:center;">
          <svg width="11" height="11" viewBox="0 0 24 24" fill="none"><path d="M12 2C8.13 2 5 5.13 5 9c0 2.38 1.19 4.47 3 5.74V17c0 .55.45 1 1 1h6c.55 0 1-.45 1-1v-2.26C17.81 13.47 19 11.38 19 9c0-3.87-3.13-7-7-7z" fill="rgba(184,204,240,0.95)"/></svg>
        </div>
        <span style="font-size:11px;color:#94a3b8;font-weight:500;">Support Assistant</span>
      </div>
      <div class="_msg-bubble" style="
